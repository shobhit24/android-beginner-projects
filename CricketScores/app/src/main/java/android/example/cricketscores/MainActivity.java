package android.example.cricketscores;
...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Decides the winner of the current match played.
     */
    ...
    /**
     * Displays the results of the current match played.
     */
    public void displayResult(String message) {
        TextView resultView = (TextView) findViewById(R.id.result_display);
        resultView.setText(String.valueOf(message));
    }

    /**
     * Resets the score for back to 0 for a new game.
     */
