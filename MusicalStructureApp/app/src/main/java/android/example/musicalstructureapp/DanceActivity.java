...
public class DanceActivity extends AppCompatActivity implements ListView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opuses.add(new Opus("Chris Martin", "Tyga - Test"));
        opuses.add(new Opus("Amy Wadge", "Tyga - Girls have fun"));
        opuses.add(new Opus("Dan Smith", "Marshmello & Bastille - Happier "));
        opuses.add(new Opus("Andrew Taggart", "The Chainsmokers & Coldplay - Something just like this"));
