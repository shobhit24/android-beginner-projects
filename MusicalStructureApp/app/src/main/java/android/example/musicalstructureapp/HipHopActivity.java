...
public class HipHopActivity extends AppCompatActivity implements ListView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opuses.add(new Opus("Steve Mac",
                "Off Set - Ric flair drip"));
        opuses.add(new Opus("Aubrey Graham",
                "Lil Baby - Drip too hard"));
        opuses.add(new Opus("Jordan Oritz",
                "Drake - I'm upset"));
        opuses.add(new Opus("Austin Post",
                "Post Malone - Wow"));
        opuses.add(new Opus("Joe Cole",
                "J.Cole - Middle child"));
